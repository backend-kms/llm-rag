...
# AIHub 초거대 AI 헬스케어 질의응답 데이터셋 - 응급질환
# https://www.aihub.or.kr/aihubdata/data/view.do?currMenu=115&topMenu=100&dataSetSn=71762

base_directory = "응급질환"
questions_directory = os.path.join(base_directory, "응급질환_질문")
answers_directory = os.path.join(base_directory, "응급질환_답변")

output_jsonl_file = "fine-tuning-data/ai-hub2/emergency.jsonl"
        ...
        for index in range(number_of_pairs_to_process):
            ...
            if prompt_text and completion_text:
                jsonl_entry = {
                    ...
                    "source": "AIHub 응급질환 Q&A 라벨링 데이터셋"
                }
