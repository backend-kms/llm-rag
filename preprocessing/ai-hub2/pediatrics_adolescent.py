...
base_directory = "소아청소년질환"
questions_directory = os.path.join(base_directory, "소아청소년질환_질문")
answers_directory = os.path.join(base_directory, "소아청소년질환_답변")

output_jsonl_file = "fine-tuning-data/ai-hub2/pediatrics_adolescent.jsonl"
        ...
        for index in range(number_of_pairs_to_process):
            ...
            if prompt_text and completion_text:
                jsonl_entry = {
                    ...
                    "source": "AIHub 소아청소년질환 Q&A 라벨링 데이터셋"
                }
